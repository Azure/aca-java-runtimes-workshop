...
[NOTE]
====
Additional telemetry can be enabled using Application Insights for Spring Boot Native applications. You can read more about it on the https://github.com/jeanbisutti/applicationinsights-spring-native[applicationinsights-spring-native] repository.
====
