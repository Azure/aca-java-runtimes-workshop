...
[source,indent=0]
----
include::{workshop-github-raw}/micronaut-app/src/main/java/io/containerapps/javaruntime/workshop/micronaut/MicronautApplication.java[tag=adocHeader]
----
...
Create the `Statistics` entity in the `src/main/java/io/containerapps/javaruntime/workshop/micronaut` package.
