...
In your repository you should have a directory called `springboot-app-app` .
...
curl 'localhost:8703/springboot/cpu?iterations=1000'
curl 'localhost:8703/springboot/cpu?iterations=1000&db=true'

curl 'localhost:8703/springboot/memory?bites=100'
curl 'localhost:8703/springboot/memory?bites=1000'
curl 'localhost:8703/springboot/memory?bites=1000&db=true'
----
