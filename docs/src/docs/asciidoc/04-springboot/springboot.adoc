...
[source,indent=0]
----
include::{workshop-github-raw}/micronaut-app/src/main/resources/application.properties[]
----
...
[source,indent=0]
----
include::{workshop-github-raw}/springboot-app/src/test/java/io/containerapps/javaruntime/workshop/springboot/SpringbootApplicationTest.java[]
----
