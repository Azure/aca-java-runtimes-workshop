...
[source,yaml]
----
include::{workshop-github-raw}/.github/workflows/deploy-quarkus-native.yml[tag=adocBuild]
----
...
In your `target` folder, this should create a binary called `./target/micronaut-app`. You can execute it
directly, for example:
...
[source,yaml]
----
include::{workshop-github-raw}/.github/workflows/deploy-micronaut-native.yml[tag=adocBuild]
----
...
In your `target` folder, this should create a binary called `springboot-app`. You can execute it
directly, for example:
...
[source,yaml]
----
include::{workshop-github-raw}/.github/workflows/deploy-springboot-native.yml[tag=adocBuild]
----
