...
You should now see the results of the load tests for the native images, and you can compare them to the results of the JVM images.

//image::../images/java-runtimes-dashboard-native.png[Screenshot of the Java Runtimes dashboard]