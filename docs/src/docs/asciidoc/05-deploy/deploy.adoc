...
include::../../../../../.github/workflows/deploy.yml[tag=adocGitHubActionsWorkflowBase]
----
...
[source,yaml]
----
include::../../../../../.github/workflows/deploy.yml[tag=adocBuild]
----
...
[source,yaml]
----
include::../../../../../.github/workflows/deploy.yml[tag=adocPush]
----
...
[source,yaml]
----
include::../../../../../.github/workflows/deploy.yml[tag=adocDeploy]
----
...
[source,shell]
----
include::../../../../../scripts/infra/deploy.sh[tag=adocRegistryCredentials, indent=0]
----
...
[source,shell]
----
include::../../../../../scripts/infra/azure.sh[tag=adocCreatePrincipal, indent=0]
----
...
[source,shell]
----
include::../../../../../scripts/infra/deploy.sh[tag=adocIngressUpdate, indent=0]
----
