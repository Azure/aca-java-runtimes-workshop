...
You can execute a SQL statement directly in the database with the following command to check the content of the `Statistics_Quarkus` table (which should be empty at this stage):
