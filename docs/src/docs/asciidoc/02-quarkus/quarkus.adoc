...
The resource is defined in the `src/main/java/io/containerapps/javaruntime/workshop/quarkus/QuarkusResource.java` file:
...
This is very easy to do with Panache.
...
curl 'localhost:8701/quarkus/cpu?iterations=1000'
curl 'localhost:8701/quarkus/cpu?iterations=1000&db=true'

curl 'localhost:8701/quarkus/memory?bites=100'
curl 'localhost:8701/quarkus/memory?bites=1000'
curl 'localhost:8701/quarkus/memory?bites=1000&db=true'
----
